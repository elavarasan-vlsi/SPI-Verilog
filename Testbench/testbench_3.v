...
// testing underflow it should remains idle when Tx_FIFO is empty after the transmission
// result at Waveforms/testbench_3cb
...
module top_module ();
    ...
    initial begin
        ...
        #100 Tx_input = 8'h55;
        #1090 Tx_write_en = 1;  // storing 55 byte in Tx_FIFO
        #10 Tx_write_en = 0;     
